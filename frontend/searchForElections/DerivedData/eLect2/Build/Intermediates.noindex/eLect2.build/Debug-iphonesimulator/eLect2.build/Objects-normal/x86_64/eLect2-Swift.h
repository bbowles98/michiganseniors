...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="eLect2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6eLect211AppDelegate")
...
SWIFT_CLASS("_TtC6eLect213SceneDelegate")
...
SWIFT_CLASS("_TtC6eLect220SearchViewController")
...
@interface SearchViewController (SWIFT_EXTENSION(eLect2)) <UISearchBarDelegate>
...
@interface SearchViewController (SWIFT_EXTENSION(eLect2)) <UITableViewDataSource, UITableViewDelegate>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC6eLect214ViewController")
